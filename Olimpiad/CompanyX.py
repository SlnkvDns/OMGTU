...
def main():
    for k in range(1, 17):
        ...
        sotrudniki = {}
        sotrudniki2 = {}
        with open(f"C:\\Users\\Denis\\Downloads\\Kompania_KhKhKh\\Компания ХХХ\\input_s1_{k:02}.txt") as f, open(f"C:\\Users\\Denis\\Downloads\\Kompania_KhKhKh\\Компания ХХХ\\output_s1_{k:02}.txt") as f2:
            s1 = f.readline().split()
